...
class MvcControlador
{
  ...
  /*****************************************************************************************************/
    ...
    {
        if(isset($_POST["nombre"]) && isset($_POST["precio"]) && isset($_POST["cantidad"]) && isset($_POST["codigo"]) && isset($_FILES["foto"]) && isset($_POST["categoria"]))
        {
          ...
          echo $ruta_nuevo_destino;
            $datos = array("nombre"=>$_POST["nombre"] , "precio"=>$_POST["precio"] , "cantidad"=>$_POST["cantidad"], "codigo"=>$_POST["codigo"],
                           "ruta"=>$ruta_nuevo_destino,"categoria"=>$_POST["categoria"]);
            print_r($datos);
           $respuesta = Datos::setProducto($datos);
          return $respuesta;
        }
   ...
   public function AddCategoria()
    {
        if(isset($_POST["nombre"]) && isset($_POST["descripcion"]))
        {
            ...
            //print_r($datos);
            $respuesta = Datos::setCategoria($datos);
            return $respuesta;
        }
