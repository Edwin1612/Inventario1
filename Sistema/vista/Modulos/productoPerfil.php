                        ...
                        <div class="modal-body" >
                            <FORM method="POST" enctype="multipart/form-data">
                                <div class="form-group">    
                                    ...
                                    <input class="form-control" type="text" name="cantidad" placeholder="Valor numerico" value="">
                                </div>
                                <div class="form-group">    
                                    <label for="user" style="color:#111;">Referencia:</label>
                                    <input class="form-control" type="text" name="referencia" placeholder="Referencia" value="">
                                </div>
                                <div class="form-group">    
                                    <label for="user" style="color:#111;">Notacion:</label>
                                    <input class="form-control" type="text" name="notacion" placeholder="Notacion" value="">
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12" >
